	...
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
							...
							<div class="card-body">
								<div class="row">
									<div class="col text-center">
										<a href="add_expense.php"><img src="icon/addex.png" width="60px"><p>Add Expense</p></a>
									</div>
									<div class="col text-center">
										<a href="add_expense.php"><img src="icon/maex.png" width="60px"><p>Manage Expense</p></a>
									</div>
									<div class="col text-center">
										<a href="add_expense.php"><img src="icon/prof.png" width="60px"><p>User Profile</p></a>
									</div>
								</div>
							</div>
						</div>
				...
				<h3 class="mt-5">Full Expense Report</h3>
				<div class="row">
					<div class="col-md">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title terxt-center">Yearly Expense</h5>
							</div>
							<div class="card-body">
					...
					<div class="col-md">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title terxt-center">Expense Category</h5>
							</div>
							<div class="card-body">
